...
const eventCategoryLabel = value => ({SOURCE_BALANCE:'账户余额',SOURCE_SCAN:'数据源扫描',TARGET_SYNC:'目标节点同步',GROUP_AVAILABILITY:'分组可用性',ACTION_EXECUTION:'远程调度写入',ACCOUNT_PLATFORM_SYNC:'账号平台校正',ACCOUNT_MODEL_SYNC:'账号模型校正',CHANNEL_PROBE:'渠道探测'})[value]||value
